...
import { Placeholder } from '../components/private/Placeholder/Placeholder';
import { BraidSnippet } from '../components/private/Snippets';
import { Autosuggest, TextField } from '../playroom/components';
  ...
  code: source(
    <>
      ...
      <Stack space="xlarge">
        ...
        >
          <ContentBlock>
            <Stack space="medium">
              ...
              <Columns space="xxsmall" collapseBelow="tablet">
                <Column>
                  <Autosuggest
                ...
                <Column width="content">
                  <Button tone="brandAccent">Find Jobs</Button>
                </Column>
              </Columns>
            </Stack>
          </ContentBlock>
          ...
          <Stack space="large">
                ...
                <Stack space="gutter">
                  <Box
                    style={{
                      height: 120,
                      background:
                        'url(https://au.cdn.gradconnection.com/media/uploads/SEEK-pink.jpg) no-repeat center center /cover',
                    }}
                  />
                  <Heading level="4">SEEK</Heading>
                  <Text>
                    The SEEK Strategy & Operations Graduate Program is
                    one-of-a-kind. It combines the best of s...
                  </Text>
                  <Text align="right">
                ...
                <Stack space="gutter">
                  <Box
                    style={{
                      height: 120,
                      background:
                        'url(https://au.cdn.gradconnection.com/media/uploads/Optiver_Logo_GC.jpg) no-repeat center center /cover',
                    }}
                  />
                  <Heading level="4">Optiver</Heading>
                  <Text>
                    Optiver is a high-frequency trading firm that improves the
                    market by solving the world’s mo...
                  </Text>
                  <Text align="right">
                    <TextLink href="#">Find out more...</TextLink>
                  </Text>
                ...
                <Stack space="gutter">
                  <Box
                    style={{
                      height: 120,
                      background:
                        'url(https://au.cdn.gradconnection.com/media/uploads/PwC.jpg) no-repeat center center /cover',
                    }}
                  />
                  <Heading level="4">PwC</Heading>
                  <Text>
                    Want to play a part in helping Australian businesses,
                    not-for- profits and governments crea...
                  </Text>
                  <Text align="right">
                    <TextLink href="#">Find out more...</TextLink>
                  </Text>
                ...
                <Stack space="gutter">
                  <Box
                    style={{
                      height: 120,
                      background:
                        'url(https://media.cdn.gradconnection.com/uploads/2d857bad-8fb3-4017-a035-de6eb953b625-social.jpg) no-repeat center center /cover',
                    }}
                  />
                  <Heading level="4">Follow</Heading>
                  <Text>
                    Join our community on Facebook. Follow us to stay up to date
                    with the latest career tips, j...
                  </Text>
                  <Text align="right">
                    <TextLink href="#">Find out more...</TextLink>
                  </Text>
            ...
            <Columns space="gutter" collapseBelow="tablet">
              <Column>
                <Stack space="gutter">
                  {[
                    {
                      ...
                      count: 19,
                      logo:
                        'https://media.cdn.gradconnection.com/uploads/a4dbb66d-e17b-476c-b471-90f380307753-KPMG.JPG',
                      jobs: [
                        {
                          ...
                          type: 'Event',
                          location: 'Canberra',
                          additionalLocations: '7 other locations',
                          startDate: '9 March 2021',
                          closingSoon: 'in 2 days',
                          standOut: true,
                          action: 'Register to event',
                        ...
                        },
                        {
                          ...
                          type: 'Event',
                          location: 'Canberra',
                          additionalLocations: '14 other locations',
                    ...
                    },
                    {
                      ...
                      count: 6,
                      logo:
                        'https://media.cdn.gradconnection.com/uploads/7a570e32-1e49-402f-98cb-ba2eebf0f2f4-mondelez-logo.jpg',
                      jobs: [
                        {
                    ...
                    },
                    {
                      ...
                      count: 3,
                      logo:
                        'https://media.cdn.gradconnection.com/uploads/b51966ef-ff48-4672-b9b9-4d6e72cc1e13-nab-new-logo.png',
                      jobs: [
                        {
                    ...
                    <Card key={company.name}>
                      <Stack space="gutter">
                          ...
                          <Column>
                            <Stack space="small">
                              <Heading level="3" weight="weak">
                                <TextLink href="#">{company.name}</TextLink>
                              </Heading>
                              <Text>
                                <Strong>{company.count}</Strong> jobs available
                              </Text>
                            </Stack>
                          </Column>
                        </Columns>
                        {company.jobs.map((job, index) => (
                          <Box
                            key={`${job.title}_${index}`}
                            padding="gutter"
                            borderRadius="standard"
                            boxShadow={
                              job.standOut ? 'borderStandard' : undefined
                            }
                            background={job.standOut ? 'body' : undefined}
                          >
                            <Stack space="large">
                              <Columns
                                space={['medium', 'gutter']}
                                  ...
                                  <Column width="content">
                                    <Stack space="small">
                                      <Text size="small" tone="critical">
                                        <IconTime /> Closing {job.closingSoon}
                                      </Text>
                                    </Stack>
                                  </Column>
                                ) : null}
                                <Column>
                                  <Stack space="medium">
                                    ...
                                    <Heading level="4" weight="weak">
                                      <TextLink href="#">{job.title}</TextLink>
                                    </Heading>
                                  </Stack>
                                </Column>
                              </Columns>
                              ...
                              >
                                <Column>
                                  <Stack space="small">
                                    <Text weight="strong">
                                      Hiring applicants with degrees in
                                    </Text>
                                    <Inline
                                      space={['small', 'xxsmall']}
                                      alignY="center"
                                    >
                                      <Tag>{job.degrees[0]}</Tag>
                                      <Text>
                                        and{' '}
                                        <TextLink href="#">
                                          {job.degrees.length} other degrees
                                        </TextLink>
                                      </Text>
                                    </Inline>
                                  </Stack>
                        ...
                        <Text align="center">
                          <TextLink href="#">
                            View all {company.count} jobs from {company.name}
                          </TextLink>
                        </Text>
                      </Stack>
                    </Card>
                  ...
                  <Inline space="none" align="center">
                    <Button variant="ghost" tone="brandAccent" size="small">
              ...
              <Hidden below="desktop">
                <Column width="content">
                  <Placeholder width={240} height={800} />
                </Column>
              </Hidden>
            </Columns>
          </Stack>
        ...
        <Box>
          <Box background="card" padding="medium">
            <ContentBlock>
              <Columns
                space={['large', 'gutter']}
                alignY="center"
          ...
          >
            <ContentBlock>
              <Stack space={['large', 'large', 'gutter']}>
                <Columns space={['xlarge', 'gutter']} collapseBelow="tablet">
                  <Column>
                    <Stack space="medium">
                      <Heading level="3">Get your first graduate job</Heading>
                      <Text size="small">
                        When you sign up for GradConnection you know you are
                        becoming a member of the biggest and most popular
                        student and graduate careers website in Australia. Over
                        500 of Australia&rsquo;s top employers advertise on
                        GradConnection, with many targeting specific types of
                        students and graduates so you will only be able to see
                        their jobs by registering!
                      </Text>
                      <Inline space="none">
                  ...
                  <Column>
                    <Stack space="medium">
                      <Heading level="3">Hiring Graduates?</Heading>
                      <Text size="small">
                        Start receiving applications today from
                        GradConnection&rsquo;s student and graduate members!
                        When you post a job with us you can be highly targeted
                        to key disciplines, universities and many other
                        characteristics to make sure your job add reaches the
                        right members. Your job will not only appear on our
                        website, it will also be sent to relevant member
                        accounts and also out to our partner universities.
                      </Text>
                      <Inline space="none">
                        <Button variant="ghost" size="small">
                ...
                <Divider />
                <Inline
                  space={['medium', 'medium', 'xsmall']}
                  collapseBelow="desktop"
                >
                  <Text>Address: L14, 100 Pacific Hwy, North Sydney</Text>
                  <Hidden below="desktop">
                    <Text tone="secondary">|</Text>
                  </Hidden>
                  <Text>Phone: (02) 8005 0266</Text>
                  <Hidden below="desktop">
                    <Text tone="secondary">|</Text>
                  </Hidden>
                  <Text>Email: info@gradconnection.com</Text>
                  <Hidden below="desktop">
                    <Text tone="secondary">|</Text>
                  </Hidden>
